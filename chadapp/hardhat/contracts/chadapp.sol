...
contract ChadApp {
    ...
    //GET USERNAME
    function getUserName(address pubkey)
        external
        view
    ...
    function addFriend(address friend_key, string calldata name) external {
        require(checkUserExists(msg.sender), "Create an account to proceed!");
        ...
        require(
            ...
            "User is already added friend"
        );

        _addFriend(msg.sender, friend_key, name);
        _addFriend(friend_key, msg.sender, userList[msg.sender].name); //update both reqd
    }
